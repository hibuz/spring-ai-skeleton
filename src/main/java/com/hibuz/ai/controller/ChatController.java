...
public class ChatController implements InfoContributor {
    ...
    public Map<String, Object> rebuildClient(@Schema(example = "ollama") @PathVariable String modelTypeName,
                                           @Schema(example = "ollama(qwen2.5:0.5b,1.5b,3b,7b, qwen3:0.6b,1.7b, qwen3.5:0.8b, gemma3:1b, llama3.2:1b,3b, deepseek-r1:1.5b,7b,8b,14b, phi4:7b, mistral14b, llama3.2-vision:11b, llava:7b,13b, llava-llama3:8b)")
